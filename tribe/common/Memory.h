...
public:
    ...
    _PORT(bool)                      read0_in;
    _PORT(logic<MEM_WIDTH_BYTES*8>)  read0_data_out = _ASSIGN_COMB( read_data0_out_comb_func() );
    ...
    _PORT(bool)                      read1_in;
    _PORT(logic<MEM_WIDTH_BYTES*8>)  read1_data_out = _ASSIGN_COMB( read_data1_out_comb_func() );
