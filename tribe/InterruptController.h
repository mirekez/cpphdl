...
public:
    ...
    _PORT(uint32_t) interrupt_cause_out = _ASSIGN_COMB(interrupt_cause_comb_func());
    _PORT(bool) interrupt_to_supervisor_out = _ASSIGN_COMB(interrupt_to_supervisor_comb_func());
