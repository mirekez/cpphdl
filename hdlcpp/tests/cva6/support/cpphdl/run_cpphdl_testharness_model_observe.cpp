...
void cpphdl_model_trace_irq(uint64_t cycle)
{
    ...
    std::fprintf(stderr,
	    ...
	    std::fprintf(stderr,
	                 ...
	                 static_cast<void*>(std::addressof(xbarCore.mst_ports_req_o_ar_valid_comb)),
    ...
    std::fprintf(stderr,
                 ...
                 static_cast<unsigned long long>(static_cast<uint64_t>(romMux.slv_reqs_i_in__field_ar_addr()[0])),
